...
with col3:
    st.link_button(":sound:", "https://www.merriam-webster.com/dictionary/ma%C3%AEtre%20d%27")
...
st.write("""Our aim is to democratize cytometry antibody data and give you the necessary tools to significantly 
